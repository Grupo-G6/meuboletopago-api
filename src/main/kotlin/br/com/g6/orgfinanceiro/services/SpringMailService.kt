...
class SpringMailService {
    ...
    fun textoBoasVindas(nome: String) : String {
        val texto = "Olá, $nome,\n" +
                ...
                "\n" +
                "Então, vamos começar? \n" +
                "Registrar a primeira movimentação é o passo inicial para um futuro com  muito dinheiro no bolso,  boletos pagos pra dar e vender (ou não, melhor só pagar mesmo). \n" +
